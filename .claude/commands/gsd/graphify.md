...
Knowledge graph is disabled. To activate:
  ...
  node /Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/get-shit-done/bin/gsd-tools.cjs graphify status
```
...
```bash
node /Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```bash
node "/Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "/Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build snapshot \
  && node "/Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/get-shit-done/bin/gsd-tools.cjs" graphify status
```

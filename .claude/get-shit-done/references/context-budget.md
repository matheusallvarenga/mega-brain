...
The keys live in `.claude/settings.json` (project) or `/Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/settings.json` (global) — **not** in `.planning/config.json`:

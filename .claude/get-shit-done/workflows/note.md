...
- **Global scope**: `/Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/notes/`)
...
2. Glob `/Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/matheusallvarenga/Desktop/itm-dev/github/03-third-party-repos/mega-brain/.claude/notes/` — works in any directory
